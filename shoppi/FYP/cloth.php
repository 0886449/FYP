...
<div class="w3-top" style="margin-left: -160px;">
    <div class="w3-row w3-large w3-light-grey">
      ...
      <div class="w3-col m2">
        <a href="inde1.php" class="w3-button w3-block">Home</a>
      </div>
      <div class="w3-col m2">
        <a href="cloth.html" class="w3-button w3-block">Plans</a>
      </div>
      <div class="w3-col m2">
        <a href="inde1.php#about" class="w3-button w3-block">About</a>
      </div>
      <div class="w3-col m2">
        <a href="inde1.php#contact" class="w3-button w3-block">Contact</a>
      </div>
      <div class="w3-col m2">
  ...
  <div class="w3-row w3-grayscale">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <img src="images/unisex1.jpg" style="width:100%">
        <p>Ripped Skinny Jeans<br><b>$24.99</b></p>
      </div>
      <div class="w3-container">
        <img src="images/unisex2.jpg" style="width:100%">
